...
final class MainPresenter {
    ...
    private func handleDownloadedTrends(data: [Gif]) {
    ...
    private func handleDownloadedSearch(data: [Gif], searchText: String) {
        viewInput?.setNoResultsView(hidden: true)
    ...
    private func reload(data: [Gif]) {
        gifDataArray = data
        viewInput?.reloadData()
        viewInput?.scrollToTop()
    }
    
    private func add(data: [Gif]) {
